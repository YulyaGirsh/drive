...
def create_exact_40_categories():
    """Создает файл с ровно 40 категориями, объединяя некоторые"""
    ...
    merge_rules = {
        ...
        "Перевозка людей": "Перевозка людей",
        
        "Перевозка грузов": "Перевозка грузов",

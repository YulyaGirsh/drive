...
def fix_categories():
    """Исправляет маппинг всех 44 категорий в 40"""
    
    # Загружаем данные
    with open('questions_categorized.json', 'r', encoding='utf-8') as f:
        data = json.load(f)
    
    # Полный маппинг всех 44 категорий в 40
    complete_mapping = {
        # Объединяем дубликаты знаков
        ...
        # Объединяем комбинированные категории в основные
    ...
    for question in data['questions']:
        ...
        if original_main_category in complete_mapping:
            question['main_category'] = complete_mapping[original_main_category]
            # Обновляем теги
            question['tags'] = [complete_mapping[original_main_category].lower().replace(' ', '_')]

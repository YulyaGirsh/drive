#!/usr/bin/env python3
"""
Тестирование с реальным API Т-банка
"""
...
def test_tbank_init():
    """Тестирует API /v2/Init с правильным токеном"""
    ...
    data = {
        ...
        "Description": "Test payment for EasyDrive",
    ...
    print("🧪 Тестирование API /v2/Init Т-банка")
    print("=" * 60)
